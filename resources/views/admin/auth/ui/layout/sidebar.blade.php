...
{{--                <li class="side-nav-title side-nav-item">Navigation</li>--}}
               ...
               {{--     Testimonial Part start    --}}
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarTestimonials" aria-expanded="false" aria-controls="sidebarBlogs" class="side-nav-link">
                        <i class="uil-store"></i>
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarServices" aria-expanded="false" aria-controls="sidebarBlogs" class="side-nav-link">
                        <i class="uil-store"></i>
                        <span> Service </span>
                        <span class="menu-arrow"></span>
                    </a>
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarDoctors" aria-expanded="false" aria-controls="sidebarBlogs" class="side-nav-link">
                        <i class="uil-store"></i>
                        <span> Doctor </span>
                        <span class="menu-arrow"></span>
                    </a>
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                           aria-expanded="false">
                            ...
                            <span>
                                        <span class="account-user-name">Anik Saha</span>
