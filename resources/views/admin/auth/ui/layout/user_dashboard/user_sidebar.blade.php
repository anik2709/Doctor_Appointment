        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            ...
            <ul class="side-nav">
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarUserDashboards" aria-expanded="false"
                           aria-controls="sidebarUserDashboards" class="side-nav-link">
                    ...
                    {{--Online Appointment Application Status Start--}}

                    <li class="side-nav-item">
                      <a data-bs-toggle="collapse" href="#sidebarUserAppointmentDetails"
                       aria-expanded="false" aria-controls="sidebarBlogs" class="side-nav-link">
                        <i class="uil-store"></i>
                        <span> Online Appointment Application Status </span>
                        <span class="menu-arrow"></span>
                      </a>
                     <div class="collapse" id="sidebarUserAppointmentDetails">
                        <ul class="side-nav-second-level">
                            <li>
                                <a href="{{route('user_appointment.details')}}">Appointment Status</a>
                            </li>
                        </ul>
                     </div>
                </li>

                    {{--Online Appointment Application Status End--}}
...
{{--                                        <span class="account-position">{{\Auth::user()->id}}</span>--}}
                                    </span>
                        </a>
                        <div
